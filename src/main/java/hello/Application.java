...
public class Application {
    ...
    /*
     * @PostMapping("/**") public String index(@RequestBody ArenaUpdate arenaUpdate)
     * { System.out.println(arenaUpdate); String[] commands = new String[]{"F", "R",
     * "L", "T"}; int i = new Random().nextInt(4); return commands[i]; }
     */
    ...
    private boolean areEnemiesToTheBack(ArenaUpdate arenaUpdate) {
        ...
        return arenaUpdate.arena.state.entrySet().stream()
                .filter(x -> !x.getKey().equals(arenaUpdate._links.self.href))
